...
export default {
  ...
  computed:{
    ...
    map: function(){
      return `https://open.mapquestapi.com/staticmap/v5/map?key=${process.env.VUE_APP_MAPQUESTAPI_KEY}&locations=${this.info.country.name}&center=UA&size=900,400&type=map` 
    }
  },
  watch: {
